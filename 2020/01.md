...
* Outreach - anything that touches the broader community
* Marketing 

The board is working to define a charter and specifics of how each committee will be run. Please 
